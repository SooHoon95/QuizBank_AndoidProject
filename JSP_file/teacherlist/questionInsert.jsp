...
<%
	...
	String teacher_id = request.getParameter("wid");	
...
//------
	...
	try{
	    ...
	    String A = "insert into question (qno, qimage, qanswer, workbook_id";
	    String B = ") values ("+qno+",?,"+qanswer+","+teacher_id+")";
	
	    ps = conn_mysql.prepareStatement(A+B);
	    ps.setString(1, qimage);
